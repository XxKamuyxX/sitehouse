import { Box, Square, DoorOpen, Building2, Frame, Shield, Grid3x3, RectangleHorizontal, MoreHorizontal } from 'lucide-react';
...
const CATEGORIES = [
  ...
  { id: 'espelho', label: 'Espelho', icon: Frame, color: 'bg-cyan-100 text-cyan-600' },
